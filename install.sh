...
echo ""
echo "  Run:  ${C_BOLD}${APP_NAME}${C_RESET}                           (first run will prompt for credentials)"
echo "  Or:   ${C_BOLD}${APP_NAME} --host h --port p --user u --pass p${C_RESET}"
echo "  Reset:${C_BOLD} ${APP_NAME} --reset-config${C_RESET}             (clear saved credentials)"
echo ""
